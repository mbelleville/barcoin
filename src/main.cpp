...
uint256 hashGenesisBlock("0xec9abc567dd3f31f5762c09f9aeb6bdcb60853fe571b4afa32f9a7feb27108b5");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x22fc07fb9f89b25772c7e5ebf96eea3b1719e450bb5e3c46f9b564a4ab5194b4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Trump says all options on table after North Korea fires missile over Japan";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1504098674; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 455597;

        if (fTestNet)
        {
            block.nTime    = 1504037321;
            block.nNonce   = 3019813;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb7c08c098ff6aa3b49b38e734134412a53b2c094d54c59bc7a447e2a9d87f792"));
